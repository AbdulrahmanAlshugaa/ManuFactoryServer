...
{
    public class Stc_TransferMultipleStoresMatirial_Master
    {
        ...
        public List<Stc_TransferMultipleStoresMatirial_Details> TransferMultipleStoresMatirialDatails { get; set; }
