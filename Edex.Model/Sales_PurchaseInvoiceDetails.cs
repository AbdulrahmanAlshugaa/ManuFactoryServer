...
namespace Edex.Model
{
    ...
    public partial class Sales_PurchaseInvoiceDetails
    {
        ...
        public Sales_PurchaseInvoiceMaster PurchaseMaster { get; set; }

        public Sales_PurchaseInvoiceDetails()
        {
    ...
    public partial class Sales_PurchaseSaveInvoiceDetails
    {
        public int ID { get; set; }
        public int BranchID { get; set; }
        public long InvoiceID { get; set; }
        ...
        public Sales_PurchaseInvoiceSaveMaster PurchaseMaster { get; set; }


        public Sales_PurchaseSaveInvoiceDetails()
        {
