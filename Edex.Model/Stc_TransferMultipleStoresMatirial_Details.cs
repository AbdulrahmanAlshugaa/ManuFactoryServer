...
namespace Edex.Model
{
    ...
    public class Stc_TransferMultipleStoresMatirial_Details
    {
        ...
        public Stc_TransferMultipleStoresMatirial_Master TransferMultipleStoresMatirialMaster { get; set; }
        public Stc_TransferMultipleStoresMatirial_Details()
        {
            ID = 0;
            BarCode = "";
            GroupID = 0;
