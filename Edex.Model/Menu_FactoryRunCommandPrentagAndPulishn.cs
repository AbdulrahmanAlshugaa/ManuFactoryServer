...
namespace Edex.Model
{
    ...
    public partial class Menu_FactoryRunCommandPrentagAndPulishn
    {
        public  Nullable<int>  ID { get; set; }
        public Nullable<double> ComandID { get; set; }
        public Nullable<int> MachinID { get; set; }
        public string BarcodePrentag { get; set; }
        ...
        public Nullable<double> PrentagDebit { get; set; }
        public Nullable<double> PrentagCredit { get; set; }
        public DateTime PrentagDebitDate { get; set; }

        public string PrentagDebitTime { get; set; }
        public int StoreID { get; set; }
        public string StoreName { get; set; }
        public string EmpID { get; set; }
        public string EmpName { get; set; }
        
        public string PrSignature { get; set; }

        public Nullable<int> TypeOpration { get; set; }
