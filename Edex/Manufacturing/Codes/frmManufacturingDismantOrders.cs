...
{
    public partial class frmManufacturingDismantOrders : BaseForm
    {
        //list detail
        ...
        #endregion
        public frmManufacturingDismantOrders()
        {
          ...
          this.txtOrderID.Validating += new System.ComponentModel.CancelEventHandler(this.txtOrderID_Validating);
            ...
            cmbTypeStage.EditValue =10;
            FillCombo.FillComboBox(cmbTypeStageBefore, "Manu_TypeStages", "ID", PrimaryName, "", "", (UserInfo.Language == iLanguage.English ? "Select " : "حدد  "));
            cmbTypeStageBefore.EditValue = 10;
      ...
      public  void SetDataFromStageBefore(string  StoreID,int TypeStageBeforeID,int  ReferanceID, int CurrncyID)
        {
            txtStoreID.Text = StoreID;
            txtStoreIDFactory_Validating(null, null);
            cmbTypeStageBefore.EditValue=TypeStageBeforeID;
            cmbCurency.EditValue=CurrncyID;
            txtReferanceID.Text = ReferanceID.ToString();
        ...
        public void ReadRecord(int ComandID, bool flag = false)
        {
            try
            {
                ...
                {
                    DataRecordPolushin = Menu_FactoryRunCommandDismantDAL.frmGetDataDetalByID(Comon.cLong(ComandID), UserInfo.BRANCHID, UserInfo.FacilityID, 1);
                    DataRecordAfterBrntag = Menu_FactoryRunCommandDismantDAL.frmGetDataDetalByID(Comon.cLong(ComandID), UserInfo.BRANCHID, UserInfo.FacilityID, 2);
                    IsNewRecord = false;
                    ...
                    cmbTypeStageBefore.EditValue=Comon.cInt(DataRecord.Rows[0]["TypeStageBeforeID"].ToString());
        ...
        void initGridOrderDetails()
        {
            ...
            if (UserInfo.Language == iLanguage.Arabic)
            {
                ...
                GridViewOrderDetails.Columns["QTY"].Caption = "الكمية";
       ...
       private void txtGuidanceID_Validating(object sender, CancelEventArgs e)
        ...
        public void txtOrderID_Validating(object sender, CancelEventArgs e)
        {
            ...
            try
            {
                ...
                if (txtOrderID.Text != string.Empty && txtOrderID.Text != "0")
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        txtTypeOrder.Text = dt.Rows[0]["TypeOrdersID"].ToString();
                        ...
                        txtGuidanceID_Validating(null, null);
                        txtOrderDate.EditValue = Comon.ConvertSerialToDate(dt.Rows[0]["OrderDate"].ToString());
                        txtOrderDate.ReadOnly = true;
        ...
        private void Save()
        {

            {
                ...
                objRecord.TypeStageBeforeID= Comon.cInt(cmbTypeStageBefore.EditValue);
                //الحسابات
