    ...
    public partial class frmCheckReceiptVoucher : Edex.GeneralObjects.GeneralForms.BaseForm
    {
        ...
        public frmCheckReceiptVoucher()
        {
            try
            {
                ...
                cmbBank.ReadOnly = !MySession.GlobalAllowChangefrmCheckReceiptVoucherBankID;
                ...
                lblDiscountAccountID.ReadOnly = !MySession.GlobalAllowChangefrmCheckReceiptVoucherDiscountAccountID;
        ...
        public void GetAccountsDeclaration()
        {
            ...
            if (dtDeclaration != null && dtDeclaration.Rows.Count > 0)
            {
                ...
                //حساب 
                DataRow[] row = dtDeclaration.Select("DeclareAccountName = 'BankAccount'");
                if (row.Length > 0)
                {
        ...
        public void ClearFields()
        {
            try
            {
                ...
                cmbBank.EditValue = MySession.GlobalDefaultCheckReceiptVoucherBankID;
        ...
        protected override void DoPrint()
        {
            ...
            try
            {
                ...
                rptForm.Parameters["BankName"].Value = cmbBank.Text.Trim().ToString();
        ...
        private bool SaveRestrictionsDaily()
        {
            ...
            if (Comon.cDbl(lblDiscountTotal.Text) > 0)
            {
                ...
                Record3.Credit = 0;
                Record3.Discount = 0;
                Record3.Release = "ماتم خصمه لمذكورين شيك قبض رقم " + VoucherID;
        ...
        private void RolesButtonSearchAccountID()
        {
            ...
            btnDiscountSearch.Enabled = MySession.GlobalAllowChangefrmCheckReceiptVoucherDiscountAccountID;
        }
