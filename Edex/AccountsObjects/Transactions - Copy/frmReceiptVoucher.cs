    ...
    public partial class frmReceiptVoucher : Edex.GeneralObjects.GeneralForms.BaseForm
    {
        ...
        private void Save()
        {
            ...
            if (listreturned.Count > 0)
            {
                ...
                long Result = ReceiptVoucherDAL.InsertUsingXML(objRecord, MySession.UserID);
                SplashScreenManager.CloseForm(false);
        ...
        protected override void DoDelete()
        {
            try
            {
                ...
                bool Result = ReceiptVoucherDAL.DeleteAcc_ReceiptVoucherMaster(model);
