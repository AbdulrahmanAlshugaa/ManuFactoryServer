    ...
    public partial class frmSpendVoucher : Edex.GeneralObjects.GeneralForms.BaseForm
    {
        ...
        public frmSpendVoucher()
        {
            ...
            try
            {
                ...
                /*********************** Roles From ****************************/
                //_____Read Only 
                //كود مؤقت حتى يتم الربط مع الصلاحيات
                MySession.GlobalAllowChangefrmSpendVoucherCurencyID = true;
                MySession.GlobalAllowChangefrmSpendVoucherCurencyID = true;
                MySession.GlobalAllowChangefrmSpendVoucherPurchasesDelegateID = true;
                MySession.GlobalAllowChangefrmSpendVoucherCreditAccountID = true;
                MySession.GlobalAllowChangefrmSpendVoucherDiscountAccountID = true;
        ...
        private void gridView1_ValidatingEditor(object sender, DevExpress.XtraEditors.Controls.BaseContainerValidateEditorEventArgs e)
        {
            ...
            if (ColName == "WeightGold")
            {
               ...
               decimal Eq = Comon.ConvertTo21Calipar(Gold, Calpir, 21);
            ...
            if (ColName == "Barcode")
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    gridView1.SetRowCellValue(gridView1.FocusedRowHandle, gridView1.Columns["Calipar"], Barcode);
                }
            }
        ...
        public void CalculatTotalBalance()
        {
            ...
            try
            {
                ...
                if (t == "True")
                    VatTotal = Comon.ConvertToDecimalPrice((Comon.ConvertToDecimalPrice(lblNetBalance.Text) - Comon.ConvertToDecimalPrice(lblDiscountTotal.Text)) / 100 * MySession.GlobalPercentVat);
                else
                    VatTotal = 0;
                lblTotalVat.Text = VatTotal.ToString("N" + MySession.GlobalNumDecimalPlaces);
                lblNetBalance.Text = (VatTotal + CreditTotal - DiscountTotal).ToString("N" + MySession.GlobalNumDecimalPlaces);
        ...
        public void MoveRec(long PremaryKeyValue, int Direction)
        {
            try
            {
                ...
                if (FormView == true)
                {
                    strSQL = "SELECT TOP 1 * FROM " + SpendVoucherDAL.TableName + " Where Cancel =0 ";
                    switch (Direction)
                    {
                        case xMoveFirst:
                            {
        ...
        protected override void DoNew()
        {
            ...
            {
                IsNewRecord = true;
                txtVoucherID.Text = SpendVoucherDAL.GetNewID().ToString();
        ...
        private void Save()
        {
            ...
            if (listreturned.Count > 0)
            {
                ...
                long Result = SpendVoucherDAL.InsertUsingXML(objRecord, MySession.UserID);
                SplashScreenManager.CloseForm(false);
                if (IsNewRecord == true)
                {
                    if (Result > 0)
        ...
        protected override void DoDelete()
        {
            try
            {
                ...
                bool Result = SpendVoucherDAL.DeleteAcc_SpendVoucherMaster(model);
        ...
        private void EnabledControl(bool Value)
        {
            ...
            foreach (GridColumn col in gridView1.Columns)
            {
                ...
                if (col.FieldName == "DebitAmount" || col.FieldName == "AccountID" || col.FieldName == "Declaration" || col.FieldName == "Discount" || col.FieldName == "CostCenterID")
                {
        ...
        #endregion
        private void frmSpendVoucher_Load_1(object sender, EventArgs e)
        {
        ...
        private void chkisVat_Validating(object sender, CancelEventArgs e)
        {
        ...
        private void frmSpendVoucher_Shown(object sender, EventArgs e)
        {
            cmbBranchesID.EditValue = UserInfo.BRANCHID;
            GetAccountsDeclaration();
        }
