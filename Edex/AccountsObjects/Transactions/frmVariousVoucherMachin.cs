...
{
    public partial class frmVariousVoucherMachin : Edex.GeneralObjects.GeneralForms.BaseForm
    {
        #region Declare
        DataTable dtDeclaration;
        string FocusedControl = "";
        public CultureInfo culture = new CultureInfo("en-US");
        private VariousVoucherMachinDAL cClass;
        ...
        BindingList<Acc_VariousVoucherMachinDetails> AllRecords = new BindingList<Acc_VariousVoucherMachinDetails>();

        //list detail
        BindingList<Acc_VariousVoucherMachinDetails> lstDetail = new BindingList<Acc_VariousVoucherMachinDetails>();

        //Detail
        Acc_VariousVoucherMachinDetails BoDetail = new Acc_VariousVoucherMachinDetails();

        #endregion
        public frmVariousVoucherMachin()
        {
        ...
        void InitGrid()
        {             
            lstDetail = new BindingList<Acc_VariousVoucherMachinDetails>();
            ...
            gridView1.Columns["FinalType"].Visible = false;
            ...
            gridView1.Columns["CreditGold"].Caption = "دائـن ذهب";
            gridView1.Columns["DebitGold"].Caption = "مديـن ذهب";

            gridView1.Columns["CreditDiamond"].Caption = "دائـن الماس";
            gridView1.Columns["DebitDiamond"].Caption = "مديـن الماس";

            gridView1.Columns["CreditMatirial"].Caption = "دائـن مواد خام";
            gridView1.Columns["DebitMatirial"].Caption = "مديـن مواد خام";
            ...
            if (UserInfo.Language == iLanguage.English)
            {
                gridView1.Columns["CreditGold"].Caption = "Credit Gold";
                gridView1.Columns["DebitGold"].Caption = "Debit Gold";

                gridView1.Columns["CreditDiamond"].Caption = "Credit Diamond";
                gridView1.Columns["DebitDiamond"].Caption = "Debit Diamond";

                gridView1.Columns["CreditMatirial"].Caption = "Credit Matirial";
                gridView1.Columns["DebitMatirial"].Caption = "Debit Matirial";
            ...
            //    //gridView1.Columns["CreditMatirial"].Visible = false;
            //    //gridView1.Columns["DebitMatirial"].Visible = false;
            //    txtDebitGold.Visible = false;
            //    txtCrditGold.Visible = false;
            //    txtdDebitDiamond.Visible = false;
            //    txtCrditDiamond.Visible = false;
            //    lblDiffrentsDiamond.Visible = false;
            //    lblDiffrentsGold.Visible = false;
        ...
        public void CalculatTotalBalance()
        {
            ...
            decimal DebitRowGold = 0;
            decimal CreditRowGold = 0;

            decimal DebitRowDiamond = 0;
            decimal CreditRowDiamond = 0;

            decimal DebitTotal = 0;
            decimal CreditTotal = 0;

            decimal DebitTotalGold = 0;
            decimal CreditTotalGold = 0;

            decimal DebitTotalDiamond = 0;
            decimal CreditTotalDiamond = 0;
            try
            {
                ...
                for (int i = 0; i <= gridView1.DataRowCount - 1; i++)
                {
                    ...
                    CreditRowGold = Comon.ConvertToDecimalPrice(gridView1.GetRowCellValue(i, "CreditGold").ToString());
                    DebitRowGold = Comon.ConvertToDecimalPrice(gridView1.GetRowCellValue(i, "DebitGold").ToString());

                    CreditRowDiamond = Comon.ConvertToDecimalPrice(gridView1.GetRowCellValue(i, "CreditDiamond").ToString());
                    DebitRowDiamond = Comon.ConvertToDecimalPrice(gridView1.GetRowCellValue(i, "DebitDiamond").ToString());

                    CreditTotal += CreditRow;
                    DebitTotal += DebitAmountRow;

                    DebitTotalGold += DebitRowGold;
                    CreditTotalGold +=CreditRowGold ;

                    DebitTotalDiamond += DebitRowDiamond;
                    CreditTotalDiamond +=CreditRowDiamond ;
                ...
                if (gridView1.FocusedRowHandle < 0)
                {
                    ...
                    var ResultGoldCredit = gridView1.GetRowCellValue(gridView1.FocusedRowHandle, "CreditGold");
                    var ResultGoldDebit = gridView1.GetRowCellValue(gridView1.FocusedRowHandle, "DebitGold");

                    CreditRowGold = ResultGoldCredit != null ? Comon.ConvertToDecimalPrice(ResultGoldCredit.ToString()) : 0;
                    DebitRowGold = ResultGoldDebit != null ? Comon.ConvertToDecimalPrice(ResultGoldDebit.ToString()) : 0;


                    var ResultDiamondCredit = gridView1.GetRowCellValue(gridView1.FocusedRowHandle, "CreditDiamond");
                    var ResultDiamondDebit = gridView1.GetRowCellValue(gridView1.FocusedRowHandle, "DebitDiamond");

                    CreditRowDiamond = ResultDiamondCredit != null ? Comon.ConvertToDecimalPrice(ResultDiamondCredit.ToString()) : 0;
                    DebitRowDiamond = ResultDiamondDebit != null ? Comon.ConvertToDecimalPrice(ResultDiamondDebit.ToString()) : 0;
                ...
                //Gold
                txtCrditGold.Text = Comon.ConvertToDecimalQty(CreditTotalGold).ToString();
                txtDebitGold.Text = Comon.ConvertToDecimalQty(DebitTotalGold)+"";
                lblDiffrentsGold.Text = (Comon.ConvertToDecimalQty(DebitTotalGold) - Comon.ConvertToDecimalQty(CreditTotalGold)) + "";
                
                
                //Diamond

                txtCrditDiamond.Text =Comon.ConvertToDecimalQty( CreditTotalDiamond)+"";
                txtdDebitDiamond.Text = Comon.ConvertToDecimalQty(DebitTotalDiamond) + "";
                lblDiffrentsDiamond.Text = (Comon.ConvertToDecimalQty(DebitTotalDiamond) - Comon.ConvertToDecimalQty(CreditTotalDiamond))+"";
            }
            catch (Exception ex)
            {
                Messages.MsgError(Messages.TitleInfo, this.GetType().Name + " " + System.Reflection.MethodBase.GetCurrentMethod().Name + " " + ex.Message);
        ...
        public void ReadRecord(long VoucherID, bool flag=false)
        {
            ...
            { 
                ClearFields();
                {
                  dt = VariousVoucherMachinDAL.frmGetDataDetalByID(VoucherID, Comon.cInt(cmbBranchesID.EditValue), UserInfo.FacilityID);
        ...
        public void MoveRec(long PremaryKeyValue, int Direction)
        {
            try
            {
                ...
                if (FormView == true)
                {
                    strSQL = "SELECT TOP 1 * FROM Acc_VariousVoucherMachinMaster Where Cancel =0  and  " + VariousVoucherMachinDAL.PremaryKey +">0";
                    switch (Direction)
                    {
                        case xMoveFirst:
                            {
                                strSQL = strSQL + " ORDER BY " + VariousVoucherMachinDAL.PremaryKey + " ASC";
                                break;
                            }

                        case xMoveNext:
                            {
                                strSQL = strSQL + " And " + VariousVoucherMachinDAL.PremaryKey + ">" + PremaryKeyValue + " ORDER BY " + VariousVoucherMachinDAL.PremaryKey + " asc";
                                break;
                            }

                        case xMovePrev:
                            {
                                strSQL = strSQL + " And " + VariousVoucherMachinDAL.PremaryKey + "<" + PremaryKeyValue + " ORDER BY " + VariousVoucherMachinDAL.PremaryKey + " desc";
                                break;
                            }

                        case xMoveLast:
                            {
                                strSQL = strSQL + " ORDER BY " + VariousVoucherMachinDAL.PremaryKey + " DESC";
                                break;
                            }
                    }
                    cClass = new VariousVoucherMachinDAL();
        ...
        protected override void DoNew()
        {
            try
            {
                isNewReg = true;
                IsNewRecord = true;
                txtVoucherID.Text = VariousVoucherMachinDAL.GetNewID().ToString();
        ...
        protected override void DoEdit()
        {
            ...
            dtItem.Columns.Add("CreditDiamond", System.Type.GetType("System.Decimal"));
            dtItem.Columns.Add("CreditGold", System.Type.GetType("System.Decimal"));
            dtItem.Columns.Add("DebitGold", System.Type.GetType("System.Decimal"));
            dtItem.Columns.Add("DebitDiamond", System.Type.GetType("System.Decimal"));
            ...
            for (int i = 0; i <= gridView1.DataRowCount - 1; i++)
            {
                ...
                dtItem.Rows[i]["CreditDiamond"] = Comon.ConvertToDecimalQty(gridView1.GetRowCellValue(i, "CreditDiamond").ToString());
                dtItem.Rows[i]["CreditGold"] = Comon.ConvertToDecimalQty(gridView1.GetRowCellValue(i, "CreditGold").ToString());
                dtItem.Rows[i]["DebitGold"] = Comon.ConvertToDecimalQty(gridView1.GetRowCellValue(i, "DebitGold").ToString());
                dtItem.Rows[i]["DebitDiamond"] = Comon.ConvertToDecimalQty(gridView1.GetRowCellValue(i, "DebitDiamond").ToString());
        ...
        private void Save()
        {
            ...
            if (listreturned.Count > 0)
            {
                ...
                long Result = VariousVoucherMachinDAL.InsertUsingXML(objRecord, IsNewRecord);
                SplashScreenManager.CloseForm(false);
        ...
        protected override void DoDelete()
        {
            try
            {
                ...
                Acc_VariousVoucherMachinMaster model = new Acc_VariousVoucherMachinMaster();
                ...
                int Result = VariousVoucherMachinDAL.DeleteAcc_VariousVoucherMachinMaster(model);
        ...
        protected override void DoPrint()
        {
            ...
            try
            {
                ...
                ReportName = "rptVariousMachinVoucher";
        ...
        private bool SaveRestrictionsDaily()
        {
            ...
            int VoucherID = Comon.cInt(txtVoucherID.Text);
            string Release = "سند قيد يومي رقم";
        ...
        private void frmVariousVoucher_Load(object sender, EventArgs e)
        {
            ...
            gridView1.ShowEditor();
           // Validations.DoVisableOnlyMoveBotton(this, ribbonControl1);
