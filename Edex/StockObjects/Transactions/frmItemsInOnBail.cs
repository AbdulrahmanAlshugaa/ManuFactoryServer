...
{
    public partial class frmItemsInonBail : Edex.GeneralObjects.GeneralForms.BaseForm
    {
        #region Declare
        //list detail
        ...
        private Stc_ItemsInonBailDAL cClass;
        ...
        BindingList<Stc_ItemsInonBail_Details> AllRecords = new BindingList<Stc_ItemsInonBail_Details>();

        //list detail
        BindingList<Stc_ItemsInonBail_Details> lstDetail = new BindingList<Stc_ItemsInonBail_Details>();

        //Detail
        Stc_ItemsInonBail_Details BoDetail = new Stc_ItemsInonBail_Details();

        #endregion
        public frmItemsInonBail()
        {
            try
            {
        ...
        void InitGrid()
        {
            lstDetail = new BindingList<Stc_ItemsInonBail_Details>();
            ...
            gridView1.Columns["ItemsInOnBailMaster"].Visible = false;
            ...
            gridView1.Columns["SpendPrice"].Caption = "تكلفة محل ";
            ...
            gridView1.Columns["CaratPrice"].Caption = "سعر الكارت";
        ...
        private void gridView1_ValidatingEditor(object sender, DevExpress.XtraEditors.Controls.BaseContainerValidateEditorEventArgs e)
        {
            ...
            else if (this.gridView1.ActiveEditor is TextEdit)
            {
                ...
                {
                    decimal CostPrice = Comon.ConvertToDecimalPrice(Comon.ConvertToDecimalPrice(val.ToString()));
        ...
        public void SumTotalBalanceAndDiscount(int row = -1)
        {
            try
            {
                ...
                for (int i = 0; i <= gridView1.DataRowCount - 1; i++)
                {
                    ...
                    DiamondRow += Comon.ConvertToDecimalPrice(gridView1.GetRowCellValue(i, "DIAMOND_W").ToString());
        ...
        public void ReadRecord(long InvoiceID, bool flag = false)
        {
            try
            {
                ...
                ClearFields();
                {
                    ...
                    dt = Stc_ItemsInonBailDAL.frmGetDataDetailByID(InvoiceID, Comon.cInt(cmbBranchesID.EditValue), UserInfo.FacilityID);
        ...
        public void MoveRec(long PremaryKeyValue, int Direction)
        {
            try
            {
                ...
                if (FormView == true)
                {
                    strSQL = "SELECT TOP 1 * FROM " + Stc_ItemsInonBailDAL.TableName + " Where Cancel =0 ";
                    switch (Direction)
                    {
                        case xMoveFirst:
                            {
                                strSQL = strSQL + " ORDER BY " + Stc_ItemsInonBailDAL.PremaryKey + " ASC";
                                break;
                            }

                        case xMoveNext:
                            {
                                strSQL = strSQL + " And " + Stc_ItemsInonBailDAL.PremaryKey + ">" + PremaryKeyValue + " ORDER BY " + Stc_ItemsInonBailDAL.PremaryKey + " asc";
                                break;
                            }

                        case xMovePrev:
                            {
                                strSQL = strSQL + " And " + Stc_ItemsInonBailDAL.PremaryKey + "<" + PremaryKeyValue + " ORDER BY " + Stc_ItemsInonBailDAL.PremaryKey + " desc";
                                break;
                            }

                        case xMoveLast:
                            {
                                strSQL = strSQL + " ORDER BY " + Stc_ItemsInonBailDAL.PremaryKey + " DESC";
                                break;
                            }
                    }
                    cClass = new Stc_ItemsInonBailDAL();
        ...
        protected override void DoNew()
        {
            ...
            {
                IsNewRecord = true;
                txtInvoiceID.Text = Stc_ItemsInonBailDAL.GetNewID(UserInfo.FacilityID, UserInfo.BRANCHID, UserInfo.ID).ToString();
                ClearFields();
                EnabledControl(true);
                txtStoreID.Focus();
        ...
        private bool AddItems(int Rowindex, string BarCode)
        {
            try
            {
                ...
                decimal Bones = Comon.cDec(gridView1.GetRowCellValue(Rowindex, "Bones").ToString());
                int Caliber = Comon.cInt(gridView1.GetRowCellValue(rowIndex, SizeName));
                //سعر تكلفة مع مصاريف
                ...
                for (int i = 0; i <= gridView1.DataRowCount - 1; i++)
                {
                    ...
                    if (dtt == null || dtt.Rows.Count <= 0)
                    {
                        ...
                        if (gridView1.GetRowCellValue(i, "DIAMOND_W").ToString() != "")
                        {
                            ...
                            objRecord.CaptionOpration = "توريد مخزني ";
        ...
        private void Save()
        {
            ...
            Stc_ItemsInonBail_Master objRecord = new Stc_ItemsInonBail_Master();
            ...
            objRecord.StoreID = Comon.cInt(txtStoreID.Text);
            objRecord.OperationTypeName = (UserInfo.Language == iLanguage.English ? "In Invoice" : "توريد مخزني ");
            txtNotes.Text = (txtNotes.Text.Trim() != "" ? txtNotes.Text.Trim() : (UserInfo.Language == iLanguage.English ? "In Invoice" : " توريد مخزني "));
            ...
            Stc_ItemsInonBail_Details returned;
            List<Stc_ItemsInonBail_Details> listreturned = new List<Stc_ItemsInonBail_Details>();

           
            for (int i = 0; i <= gridView1.DataRowCount - 1; i++)
            {
                returned = new Stc_ItemsInonBail_Details();
                returned.ID = i;
                returned.FacilityID = UserInfo.FacilityID;
                returned.BranchID = Comon.cInt(cmbBranchesID.EditValue);
               ...
               // returned.PackingQty = Comon.cInt(gridView1.GetRowCellValue(i, "PackingQty").ToString());
                ...
                returned.CaratPrice = Comon.ConvertToDecimalPrice(gridView1.GetRowCellValue(i, "CaratPrice").ToString());
                returned.SpendPrice = Comon.ConvertToDecimalPrice(gridView1.GetRowCellValue(i, "SpendPrice").ToString());
            ...
            if (listreturned.Count > 0)
            {
                objRecord.ItemsInOnBailDatails = listreturned;
                int Result = Stc_ItemsInonBailDAL.InsertUsingXML(objRecord, IsNewRecord);
                ...
                if (Comon.cInt(Result) > 0)
                {
                    ...
                    if (VoucherID == 0)
                        ...
                        Lip.ExecututeSQL("Update " + Stc_ItemsInonBailDAL.TableName + " Set RegistrationNo =" + VoucherID + " where " + Stc_ItemsInonBailDAL.PremaryKey + " = " + txtInvoiceID.Text);
        ...
        protected override void DoDelete()
        {
            try
            {
                ...
                #endregion
                Stc_ItemsInonBail_Master model = new Stc_ItemsInonBail_Master();
                ...
                int Result = Stc_ItemsInonBailDAL.Delete(model);
        ...
        private void EmportItems()
        {
            ...
            Stc_ItemsInonBail_Details obj = new Stc_ItemsInonBail_Details();


            for (int i = 0; i <= dt.Rows.Count - 1; i++)
            {
                obj = new Stc_ItemsInonBail_Details();
        ...
        public void Transaction()
        {
            ...
            strSQL = "Select * from " + Stc_ItemsInonBailDAL.TableName + " where Cancel=0 ";
                ...
                for (int i = 0; i <= dtSend.Rows.Count - 1; i++)
                {
                    ...
                    if (Comon.cInt(txtInvoiceID.Text) > 0)
                    {
                        ...
                        if (VoucherID == 0)
                            ...
                            Lip.ExecututeSQL("Update " + Stc_ItemsInonBailDAL.TableName + " Set RegistrationNo =" + VoucherID + " where " + Stc_ItemsInonBailDAL.PremaryKey + " = " + txtInvoiceID.Text + " AND BranchID=" + Comon.cInt(cmbBranchesID.EditValue));
