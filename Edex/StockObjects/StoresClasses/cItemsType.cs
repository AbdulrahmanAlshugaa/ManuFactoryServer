...
{
    public class cItemsType
    {
        public readonly string TableName = "Stc_ItemTypes";
        public readonly string PremaryKey = "TypeID";
        ...
        private void ReadRecord()
        {
            try
            {
                {
                    var withBlock = dt;
                    TypeID = int.Parse(dt.Rows[0]["TypeID"].ToString());
        ...
        public long GetNewID(int BranchID)
        {
            try
            {
                DataTable dt;
