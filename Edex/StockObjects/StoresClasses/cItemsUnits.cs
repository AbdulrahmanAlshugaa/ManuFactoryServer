...
{
    public class cItemsUnits
    {
        public readonly string TableName = "Stc_SizingUnits";
        public readonly string PremaryKey = "SizeID";
        ...
        private void ReadRecord()
        {
            try
            {
                {
                    var withBlock = dt;
                    SizeID = int.Parse(dt.Rows[0]["SizeID"].ToString());
