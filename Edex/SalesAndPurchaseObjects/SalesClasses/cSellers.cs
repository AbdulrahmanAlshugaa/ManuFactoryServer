...
namespace Edex.SalesAndPurchaseObjects.SalesClasses
{
    ...
    {
        #region declare
        public readonly string TableName = "Sales_Sellers";
        public readonly string PremaryKey = "SellerID";
        public int SellerID;
       ...
       /// </summary>
        private void ReadRecord()
        {
            try
            {
                {
                    var withBlock = dt;
                    SellerID = int.Parse(dt.Rows[0]["SellerID"].ToString());
        ...
        /// <summary>
        /// This function is used to select  Sellers by SellerID
        /// </summary>
        ...
        public long GetNewID()
        {
            try
            {
                ...
                return Convert.ToInt32(GetNewID);//return New ID
