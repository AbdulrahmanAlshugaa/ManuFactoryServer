...
{
    public partial class frmCashierSalesP : Edex.GeneralObjects.GeneralForms.BaseForm
    {
        ...
        private void FileItemData(DataTable dt)
        {
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                ...
                gridView1.SetRowCellValue(gridView1.FocusedRowHandle, gridView1.Columns["RemainQty"], Comon.cDbl((Lip.SelectRecord("SELECT [dbo].[RemindQty]('" + dt.Rows[0]["BarCode"].ToString() + "'," + Comon.cInt(txtStoreID.Text) + ") AS RemainQty")).Rows[0]["RemainQty"].ToString()).ToString("N" + MySession.GlobalPriceDigits));
