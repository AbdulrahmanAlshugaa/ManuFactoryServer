...
{
    public partial class frmCashierPurchaseSaveDaimond1 : Edex.GeneralObjects.GeneralForms.BaseForm
    {
        ...
        public frmCashierPurchaseSaveDaimond1()
        {
            try
            {
        ...
        void InitGrid()
        {
           ...
           // gridView1.Columns["Net"].OptionsColumn.AllowFocus = MySession.GlobalAllowChangefrmSaleInvoiceNetPrice;
            ...
            gridView1.Columns["GroupID"].VisibleIndex = 3;
            gridView1.Columns[GroupName].VisibleIndex = 4;
        ...
        public void MoveRec(long PremaryKeyValue, int Direction)
        {
            try
            {
                ...
                {
                    SplashScreenManager.CloseForm(false);
                    strSQL = "SELECT TOP 1 * FROM " + Sales_PurchaseInvoicesDAL.TableName + " Where  GoldUsing= " + GoldUsing + " and Cancel =0 " ;
                    switch (Direction)
                    {
                        case xMoveFirst:
                            {
        ...
        private void AddItems(int Rowindex)
        {
            try
            {
                ...
                double ItemG = Lip.GetNewID(GroupID);
        ...
        protected override void DoSave()
        {
            try
            {
                ...
                gridView1.MoveLast();
                //bool Yes = Messages.MsgStopYesNo(Messages.TitleConfirm, "سيتم اضافة مواد جديدة الى النظام اذا لم يتم ادخال كود للصنف ؟");
                //if (!Yes)
                //    return;
                Application.DoEvents();
                SplashScreenManager.ShowForm(this, typeof(WaitForm1), true, true, true);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count < 1)
                return;
            strSQL = "Select * from Sales_PurchaseInvoiceReturnMaster where SupplierInvoiceID=" + txtInvoiceID.Text + " And BranchID=" + MySession.GlobalBranchID;
