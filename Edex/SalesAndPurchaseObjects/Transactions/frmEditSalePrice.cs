...
{
    public partial class frmEditSalePrice : Edex.GeneralObjects.GeneralForms.BaseForm
    {
...
+ " (FromDate<=" + dateFrom + ")And (ToDate>=" + dateFrom + ")";
        ...
        public frmEditSalePrice()
        {
            try
            {
               ...
               // lblNetBalance.ForeColor = Color.Black;
                ...
                ribbonControl1.Pages[0].Groups[0].ItemLinks[4].Visible = true;
        ...
        void InitGrid()
        {
            ...
            gridView1.Columns["HavVat"].Visible = true;
            ...
            gridView1.Columns["HavVat"].OptionsColumn.ReadOnly = false;
        ...
        private void gridView1_ValidatingEditor(object sender, DevExpress.XtraEditors.Controls.BaseContainerValidateEditorEventArgs e)
        {
            ...
            else if (this.gridView1.ActiveEditor is TextEdit)
            {
                ...
                if (ColName == "BarCode" || ColName == "Net" || ColName == "SizeID" || ColName == "Total" || ColName == "ItemID" || ColName == "QTY" || ColName == "SalePrice")
                {
                    ...
                    if (ColName == "BarCode")
                    {
                                                    //    GetNewOffers(getitemGroup(Comon.cInt(gridView1.GetRowCellValue(i, "Caliber").ToString()), Comon.cInt(gridView1.GetRowCellValue(i, "ItemID").ToString()), Comon.cInt(gridView1.GetRowCellValue(i, "SizeID").ToString())), gridView1.GetRowCellValue(i, "BarCode").ToString(), Comon.ConvertToDecimalPrice(gridView1.GetRowCellValue(i, gridView1.Columns["QTY"])));
                           ...
                           e.Valid = true;
                            ...
                            {
                                btnCilick(val.ToString(), 1, Comon.cInt(0));
                                CalculateRow();
                                e.Valid = true;
                            ...
                            else
                            {
                                ...
                                if (dt.Rows.Count == 0)
                                {
                                    ...
                                    frmAddNewItemFromCahier frm = new frmAddNewItemFromCahier();
                                    frm.txtBarCode.Text = val.ToString();
                                    frm.ShowDialog();

                                    val = frm.txtBarCode.Text;

                                  dt = Stc_itemsDAL.GetItemData1(val.ToString(), UserInfo.FacilityID);
                                  if (dt.Rows.Count == 0)
                                  {
                                      e.Valid = false;
                                      HasColumnErrors = true;
                                  ...
                                  {
                                      btnCilick(val.ToString(), 1, Comon.cInt(dt.Rows[0]["ItemID"].ToString()));
                                      CalculateRow();
                                      e.Valid = true;
        ...
        void btnCilick(string Barcode, decimal QtyInput,int ItemID)
        {
...
//GetNewOffers(itemGroup, Barcode, QtyInput, ItemID, gridView1.FocusedRowHandle);
       ...
       void ClearOffers(){
            ...
            try
            {
                ...
                try
                {
                    if (e.KeyCode == Keys.Enter)
                    {
                        ...
                        if (Comon.ConvertToDecimalPrice(gridView1.GetRowCellValue(gridView1.FocusedRowHandle, "SalePrice").ToString()) <= 0 && (gridView1.GetRowCellValue(gridView1.FocusedRowHandle, "Description").ToString() == ""))
                            {
        ...
        private DataRow[] FileItemData(DataTable dt, decimal QtyIn)
        {
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                ...
                gridView1.SetRowCellValue(gridView1.FocusedRowHandle, gridView1.Columns["PageNo"], 0);
                gridView1.SetRowCellValue(gridView1.FocusedRowHandle, gridView1.Columns["ItemStatus"], 1);
                gridView1.SetRowCellValue(gridView1.FocusedRowHandle, gridView1.Columns["Caliber"], dt.Rows[0]["GroupID"].ToString());
                gridView1.SetRowCellValue(gridView1.FocusedRowHandle, gridView1.Columns["Equivalen"], 0);
                gridView1.SetRowCellValue(gridView1.FocusedRowHandle, gridView1.Columns["Net"], 0);
                gridView1.SetRowCellValue(gridView1.FocusedRowHandle, gridView1.Columns["TheCount"], 1);
                gridView1.SetRowCellValue(gridView1.FocusedRowHandle, gridView1.Columns["Height"], 0);
                ...
                gridView1.SetRowCellValue(gridView1.FocusedRowHandle, gridView1.Columns["Total"], 0);
                gridView1.SetRowCellValue(gridView1.FocusedRowHandle, gridView1.Columns["QTY"], QtyIn);
                gridView1.SetRowCellValue(gridView1.FocusedRowHandle, gridView1.Columns["HavVat"],Comon.cbool(Comon.cInt(dt.Rows[0]["IsVAT"].ToString())));
                ...
                if (dtPriceItemOffers.Rows.Count > 0)
                {
                    ...
                    if (dr.Length > 0 && gridView1.Columns["Description"].ToString() != "INS")
                    {

                        if (Comon.cInt(dr[0]["IsAmount"].ToString()) > 0)
                        {
                            gridView1.SetRowCellValue(gridView1.FocusedRowHandle, gridView1.Columns["Discount"], dr[0]["AmountCost"].ToString());
                            // itemgroup[2] = 1;
                        }
                        else if (Comon.cInt(dr[0]["IsPercent"].ToString()) > 0)
                        {
                            decimal PercentAmount = Comon.ConvertToDecimalPrice(dr[0]["PercentCost"].ToString());
                            decimal total = Comon.ConvertToDecimalPrice(Comon.ConvertToDecimalPrice(dt.Rows[0]["SalePrice"].ToString()) * 1 * Comon.ConvertToDecimalPrice(PercentAmount / 100));
                            gridView1.SetRowCellValue(gridView1.FocusedRowHandle, gridView1.Columns["Discount"], total);
                            gridView1.SetRowCellValue(gridView1.FocusedRowHandle, gridView1.Columns["Height"], PercentAmount);
                            gridView1.SetRowCellValue(gridView1.FocusedRowHandle, gridView1.Columns["Description"], "IsPercent");
                        ...
                        else if (Comon.cInt(dr[0]["IsOffers"].ToString()) > 0)
                        {
                           drgroupItem = dr;
                            ...
                            //    else
                            //        gridView1.SetRowCellValue(gridView1.FocusedRowHandle, gridView1.Columns["Description"], "ISOFFER1");
        ...
        private void SumTotalBalanceAndDiscount(int row = -1, bool IsHavVat = false)
        {
            try
            {
                ...
                for (int i = 0; i <= gridView1.DataRowCount - 1; i++)
                {
                    if (dtPriceItemOffers.Rows.Count > 0)
                    {
                        var dr = dtPriceItemOffers.Select("((FromGroupID<=" + gridView1.GetRowCellValue(i, gridView1.Columns["Caliber"]).ToString() + "and ToGroupID>=" + gridView1.GetRowCellValue(i, gridView1.Columns["Caliber"]).ToString() + " )AND(FromItemID<=" + gridView1.GetRowCellValue(i, gridView1.Columns["ItemID"]).ToString() + "and ToItemID>=" + gridView1.GetRowCellValue(i, gridView1.Columns["ItemID"]).ToString() + " ) and (FromSizeID<=" + gridView1.GetRowCellValue(i, gridView1.Columns["SizeID"]).ToString() + "and ToISizeID>=" + gridView1.GetRowCellValue(i, gridView1.Columns["SizeID"]).ToString() + " )) or((FromItemID<=" + gridView1.GetRowCellValue(i, gridView1.Columns["ItemID"]).ToString() + "and ToItemID>=" + gridView1.GetRowCellValue(i, gridView1.Columns["ItemID"]).ToString() + " ) and (FromSizeID<=" + gridView1.GetRowCellValue(i, gridView1.Columns["SizeID"]).ToString() + "and ToISizeID>=" + gridView1.GetRowCellValue(i, gridView1.Columns["SizeID"]).ToString() + " ))OR ((FromItemID<=" + gridView1.GetRowCellValue(i, gridView1.Columns["ItemID"]).ToString() + "and ToItemID>=" + gridView1.GetRowCellValue(i, gridView1.Columns["ItemID"]).ToString() + " ) and (FromSizeID<=" + 0 + "and ToISizeID>=" + 0 + " )) or (FromGroupID<=" + gridView1.GetRowCellValue(i, gridView1.Columns["Caliber"]).ToString() + "and ToGroupID>=" + gridView1.GetRowCellValue(i, gridView1.Columns["Caliber"]).ToString() + " ) ");
                        ...
                        if (dr.Length > 0)
                        {
                            if (Comon.cInt(dr[0]["IsOffers"].ToString()) > 0)
                            {
                                ...
                                QTyArrayList = getQtyArry(Comon.cInt(dr[0]["FromItemID"].ToString()), Comon.cInt(dr[0]["FromSizeID"].ToString()), Comon.cInt(dr[0]["ToISizeID"].ToString()), Comon.cInt(dr[0]["FromSizeOnther"].ToString()), Comon.cInt(dr[0]["ToSizeOnther"].ToString()), Comon.cInt(dr[0]["ItemIDOnther"].ToString()));
                                decimal QTYIN = QTyArrayList[0].QTYIN;
                                decimal IsInOfferQty = QTyArrayList[0].IsInOfferQty;
                                decimal QtyForOffers = QTyArrayList[0].QtyForOffers;
                                decimal QtyOffers = Comon.ConvertToDecimalQty(dr[0]["GetOntherAmount"].ToString());
                                decimal qtyinpo = Comon.ConvertToDecimalQty(dr[0]["SetOntherAmount"].ToString());
                                if (QTYIN >= QtyOffers)
                                {

                                    if (Decimal.Truncate(QTYIN / QtyOffers) > IsInOfferQty && QtyForOffers >= qtyinpo)
                                    {
                                        if (QtyForOffers == qtyinpo)
                                        {
                                            foreach (QTyArray qtyArray in QTyArrayList)
                                            {
                                                gridView1.SetRowCellValue(qtyArray.indexrow, gridView1.Columns["Height"], gridView1.GetRowCellValue(qtyArray.indexrow, gridView1.Columns["SalePrice"]));
                                                gridView1.SetRowCellValue(qtyArray.indexrow, gridView1.Columns["SalePrice"], 0);
                                                gridView1.SetRowCellValue(qtyArray.indexrow, gridView1.Columns["Description"], "ISOFFER2");
                                        ...
                                        else
                                        {
                                            ...
                                            foreach (QTyArray qtyArray in QTyArrayList)
                                            {
                                                decimal qty = Comon.ConvertToDecimalQty(gridView1.GetRowCellValue(qtyArray.indexrow, gridView1.Columns["QTY"]).ToString());
                                                if (qtyinpo == qty)
                                                {
                                                    gridView1.SetRowCellValue(qtyArray.indexrow, gridView1.Columns["Height"], gridView1.GetRowCellValue(qtyArray.indexrow, gridView1.Columns["SalePrice"]));
                                                    gridView1.SetRowCellValue(qtyArray.indexrow, gridView1.Columns["SalePrice"], 0);
                                                    gridView1.SetRowCellValue(qtyArray.indexrow, gridView1.Columns["Description"], "ISOFFER2");
                                                    gridView1.SetRowCellValue(qtyArray.indexrow, gridView1.Columns["QTY"], qty);
                                                    break;
                                                }
                                                else if (qtyinpo > qty)
                                                {
                                                    // decimal DiscountRow=Comon.ConvertToDecimalPrice(gridView1.GetRowCellValue(qtyArray.indexrow, gridView1.Columns["SalePrice"]).ToString())*
                                                    gridView1.SetRowCellValue(qtyArray.indexrow, gridView1.Columns["Height"], gridView1.GetRowCellValue(qtyArray.indexrow, gridView1.Columns["SalePrice"]));
                                                    gridView1.SetRowCellValue(qtyArray.indexrow, gridView1.Columns["Discount"], 0);
                                                    gridView1.SetRowCellValue(qtyArray.indexrow, gridView1.Columns["Description"], "ISOFFER2");
                                                    gridView1.SetRowCellValue(qtyArray.indexrow, gridView1.Columns["QTY"], qty);
                                                    qtyinpo = qtyinpo - qty;
                                                }
                                                else if (qtyinpo < qty)
                                                {
                                                    ...
                                                    gridView1.PostEditor();
                                                    gridView1.AddNewRow();
                                                    gridView1.SetRowCellValue(gridView1.FocusedRowHandle, gridView1.Columns["BarCode"], gridView1.GetRowCellValue(qtyArray.indexrow, gridView1.Columns["BarCode"]).ToString());
                                                    FileItemDataOffers(Stc_itemsDAL.GetItemData1(gridView1.GetRowCellValue(qtyArray.indexrow, gridView1.Columns["BarCode"]).ToString(), UserInfo.FacilityID), qtyinpo, "ISOFFER2");



                                                    //     decimal DiscountRow1 = Comon.ConvertToDecimalPrice(gridView1.GetRowCellValue(qtyArray.indexrow, gridView1.Columns["SalePrice"]).ToString()) * qtyinpo;
                                                    //  gridView1.SetRowCellValue(qtyArray.indexrow, gridView1.Columns["Height"], gridView1.GetRowCellValue(qtyArray.indexrow, gridView1.Columns["SalePrice"]));
                                                    /// gridView1.SetRowCellValue(qtyArray.indexrow, gridView1.Columns["Discount"], DiscountRow1);
                                                    //  gridView1.SetRowCellValue(qtyArray.indexrow, gridView1.Columns["Description"], "ISOFFER2");
                                                    gridView1.SetRowCellValue(qtyArray.indexrow, gridView1.Columns["QTY"], qty - qtyinpo);
                                                    gridView1.MoveLast();
                                                    gridView1.FocusedRowHandle = DevExpress.XtraGrid.GridControl.NewItemRowHandle;
                                                    gridView1.FocusedColumn = gridView1.VisibleColumns[1];
                                                    //gridView1.FocusedRowHandle = DevExpress.XtraGrid.GridControl.NewItemRowHandle;
                ...
                ClearFields();
                {
                    ...
                    if (dt != null && dt.Rows.Count > 0)
                    {
                       ...
                       // gridControl1.DataSource = dt;
                        ...
                        switch (Comon.cInt(dt.Rows[0]["MethodeID"].ToString()))
                        {
                            case (1): simpleButton1_Click(null,null); break;
                            case (2): simpleButton12_Click(null, null); break;
                            case (3): simpleButton2_Click(null, null); break;
                            case (4): simpleButton3_Click(null, null); break;
        ...
        private void Save()
        {
            ...
            for (int i = 0; i <= gridView1.DataRowCount - 1; i++)
            {
                ...
                strSQL = "Update Stc_ItemUnits set CostPrice =" + returned.QTY + ", SalePrice=" + returned.SalePrice + " Where BarCode= '" + returned.BarCode  + "'";
                Lip.ExecututeSQL(strSQL);

                strSQL = "Update Stc_Items set IsVAT =" + Isvat + " Where ItemID= " + returned.ItemID;
                Lip.ExecututeSQL(strSQL);


                strSQL = "Update Sales_PurchaseInvoiceDetails set CostPrice =" + returned.QTY + ", SalePrice=" + returned.SalePrice + " Where BarCode= '" + returned.BarCode + "'";
                Lip.ExecututeSQL(strSQL);
 ...
 rptForm.Parameters["NetTotal"].Value = 0;break;
                ...
                for (int i = 0; i <= gridView1.DataRowCount - 1; i++)
                {
                    ...
                    if (Comon.cInt(cmbLanguagePrint.EditValue) == 2)
                        ...
                        row["ItemName"] = gridView1.GetRowCellValue(i, "ArbItemName").ToString() + "    " + gridView1.GetRowCellValue(i, "EngItemName").ToString() + " " + gridView1.GetRowCellValue(i,"EngSizeName").ToString() + " " + gridView1.GetRowCellValue(i, "ArbSizeName").ToString();
                   // row["ItemName"] = gridView1.GetRowCellValue(i, ItemName).ToString() + gridView1.GetRowCellValue(i, "BarCode").ToString() + gridView1.GetRowCellValue(i, SizeName).ToString() + gridView1.GetRowCellValue(i, "PackingQty").ToString();
                    row["SizeName"] = gridView1.GetRowCellValue(i, SizeName).ToString();
                    row["QTY"] = gridView1.GetRowCellValue(i, "QTY").ToString();
                    row["Total"] = gridView1.GetRowCellValue(i, "Total").ToString();
 ...
 rptForm.Parameters["NetTotal"].Value = 0;break;
        ...
        private void txtNetAmount_TextChanged(object sender, EventArgs e)
        {
            ...
            txtreqiramount.Text = (Comon.cDec(lblNetBalance.Text) -  Comon.cDec(txtNetAmount.Text)).ToString();
