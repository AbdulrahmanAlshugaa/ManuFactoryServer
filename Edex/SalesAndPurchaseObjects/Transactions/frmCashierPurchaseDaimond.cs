...
{
    public partial class frmCashierPurchaseDaimond : Edex.GeneralObjects.GeneralForms.BaseForm
    {
        ...
        public frmCashierPurchaseDaimond()
        {
            try
            {
    ...
    public  void txtOrderID_Validating(object sender, CancelEventArgs e)
                    ...
                    for (int i = 0; i <= gridView1.DataRowCount - 1; i++)
                    {
                      ...
                      if (dtt == null || dtt.Rows.Count <= 0)
                      {
                          ...
                          if (gridView1.GetRowCellValue(i, "DIAMOND_W").ToString() != "")
                          {
                              ...
                              objRecord.CaptionOpration = "فاتورة مشتريات";
        ...
        private void Save()
        {
           ...
           objRecord.OperationTypeName = (UserInfo.Language == iLanguage.English ? "Purchase  Invoice" : " فاتوره  مشتريات الماس ");
           txtNotes.Text = (txtNotes.Text.Trim() != "" ? txtNotes.Text.Trim() : (UserInfo.Language == iLanguage.English ? "Purchase  Invoice" : " فاتوره  مشتريات الماس  "));
            ...
            try
            {
             ...
             rptForm.Parameters["ReportName"].Value = "فاتورة مشتريات بسعر الشراء";
                ...
                for (int i = 0; i <= gridView1.DataRowCount - 1; i++)
                {
                    ...
                    row["Net"] = Comon.cLong(row["Total"]) + Comon.cLong(row["AdditionalValue"]);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (dtReturn.Rows.Count > 0)
            {
                ...
                frm.lblTotalDaimond.Text = lblTotalDaimond.Text;
            }
            else
            {
                frmCashierPurchaseReturnDaimond frm = new frmCashierPurchaseReturnDaimond();
        ...
        public void btnUsengGold_Click(object sender, EventArgs e)
        {
            ...
            strSQL = @"SELECT    Sales_PurchaseInvoiceDetails.ID, Sales_PurchaseInvoiceDetails.InvoiceID, Sales_PurchaseInvoiceDetails.BranchID, Sales_PurchaseInvoiceDetails.ItemID, Sales_PurchaseInvoiceDetails.SizeID, 
                  ...
                  Sales_PurchaseInvoiceDetails.Color, Sales_PurchaseInvoiceDetails.ThePurity, Stc_Items.ArbName AS ItemName, Stc_Items.GroupID, Stc_Items.TypeID, Stc_Items.ColorID, 
                  Stc_Items.BrandID, Stc_Items.BaseID, Sales_PurchaseInvoiceMaster.InvoiceDate, Sales_PurchaseInvoiceMaster.SupplierID, Sales_Suppliers.ArbName AS SupplierName
