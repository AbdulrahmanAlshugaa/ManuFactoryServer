...
{
    public partial class confirmAddBalance : UserControl
    {
       ...
       Sales_SalesInvoiceMaster objRecord = new Sales_SalesInvoiceMaster();
        ...
        public confirmAddBalance(string invoiceID, string netBalance, string insurance, string Account,string customerID)
        {
            InitializeComponent();
            strQty = "";
  ...
  + "  FROM            HR_District RIGHT OUTER JOIN"
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (Comon.ConvertToDecimalPrice(txtCustomePaidAmount.Text) <= 0)
            {
                ...
                txtCustomePaidAmount.ToolTip = "  القيمة اقل من او تساوي الصفر ";
            ...
            Validations.ErrorTextClear(txtCustomePaidAmount, txtCustomePaidAmount.ToolTip);
            Validations.ErrorTextClear(txtNetAmount, txtNetAmount.ToolTip);
            int DocumentID = 0;
            int RegistrationNo = 0;
            CustomerAccount = Comon.cDbl(txtAccountID.Text);

            if (Comon.cDbl(txtCustomePaidAmount.Text) > 0 && CustomerAccount > 0)
            {
                switch (MethodID)
                {
                    case (1):
            ...
            {
                Messages.MsgError(Messages.TitleInfo, "  العميل ليس لديه حساب ");
        ...
        private int SaveRecipt(double CreditAmount, double AccountID)
        {
            ...
            objRecord.Notes = " اشتراك عميل  رصيد : ";
            ...
            returned.Declaration = " اشتراك عميل  رصيد : ";
          ...
          private int SaveVouchersDiscount(double CreditAmount, double AccountID)
        {
            ...
            objRecord.RegistrationNo = 1;
            objRecord.DelegateID = 0;
            objRecord.Notes = "خصم مسمووح  لعميل عند اشتراك يفوق 100 ريال  : ";
            objRecord.DocumentID = 1;
            ...
            returned.Credit = CreditAmount;
            returned.Debit = 0;
            returned.Declaration = "خصم مسمووح  لعميل عند اشتراك يفوق 100 ريال  : ";
            returned.CostCenterID = 0;
            listreturned.Add(returned);
            returned = new Acc_VariousVoucherDetails();
            returned.ID = 1;
