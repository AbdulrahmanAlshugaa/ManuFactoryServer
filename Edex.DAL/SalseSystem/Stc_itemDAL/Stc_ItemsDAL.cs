...
namespace Edex.DAL.Stc_itemDAL
{
    public class Stc_itemsDAL
    {
        ...
        public static Stc_ItemUnits ConvertRowToObj(DataRow dr)
        {
            ...
            Stc_Items.ItemID = Comon.cLong(dr["ItemID"].ToString());
            Stc_Items.ArbName = dr["ArbName"].ToString();
            Stc_Items.EngName = dr["EngName"].ToString();
            Stc_Items.GroupID = Comon.cDbl(dr["GroupID"].ToString());
            ...
            Stc_Items.IsService = Comon.cInt(dr["IsService"].ToString());
            Stc_Items.StopeItem = Comon.cInt(dr["StopeItem"].ToString());
            Stc_Items.IsUnbreakable = Comon.cInt(dr["IsUnbreakable"].ToString());
            ...
            Stc_ItemUnits.ItemID = Comon.cLong(dr["ItemID"].ToString());
        ...
        public static Stc_ItemUnits ConvertRowToObjAllData(DataRow dr)
        {
            Stc_Items Stc_Items = new Stc_Items();
            Stc_Items.ItemID = Comon.cLong(dr["ItemID"].ToString());
            Stc_Items.ArbName = dr["ArbName"].ToString();
            ...
            Stc_ItemUnits.ItemID = Comon.cLong(dr["ItemID"].ToString());
            Stc_ItemUnits.SizeID = Comon.cInt(dr["SizeID"].ToString());
            Stc_ItemUnits.ArbSizeName = dr["SizeName"].ToString(); 
            Stc_ItemUnits.BarCode = dr["BarCode"].ToString();         
            Stc_ItemUnits.UnitCancel = Comon.cInt(dr["UnitCancel"].ToString()); 
            Stc_ItemUnits.Stc_Items = Stc_Items;
            return Stc_ItemUnits;
        ...
        public static Stc_Items ConvertRowToObjMaster(DataRow dr)
        {
            ...
            Stc_Items.IsVAT = Comon.cInt(dr["IsVat"].ToString());
            Stc_Items.IsService = Comon.cInt(dr["IsService"].ToString());
            Stc_Items.StopeItem = Comon.cInt(dr["IsEffective"].ToString());
            Stc_Items.IsUnbreakable = Comon.cInt(dr["IsUnbreakable"].ToString());
            Stc_Items.UserID = Comon.cInt(dr["UserID"].ToString());
            Stc_Items.Cancel = Comon.cInt(dr["Cancel"].ToString());
            Stc_Items.EditDate = Comon.cLong(dr["RegDate"].ToString());
                ...
                using (SqlConnection objCnn = new GlobalConnection().Conn)
                {
                    ...
                    using (SqlCommand objCmd = objCnn.CreateCommand())
                    {
                        ...
                        if (dt != null)
                        {
                            List<Stc_ItemUnits> Returned = new List<Stc_ItemUnits>();
                            foreach (DataRow rows in dt.Rows)
                                Returned.Add(ConvertRowToObjAllData(rows));
                            return Returned;
                        }
                        else
                            return null;
        ...
        public static string InsertUsingXML(Stc_Items objRecord, Boolean IsNewRecord)
        {
            ...
            using (SqlConnection objCnn = new GlobalConnection().Conn)
            {
                ...
                using (SqlCommand objCmd = objCnn.CreateCommand())
                {
                    ...
                    objCmd.Parameters.Add(new SqlParameter("@ShowInOrderDetils", objRecord.ShowInOrderDetils));
                    objCmd.Parameters.Add(new SqlParameter("@ItemGroupID", objRecord.ItemGroupID));
                    ...
                    objCmd.Parameters.Add(new SqlParameter("@IsService", Comon.cInt(objRecord.IsService)));
                    objCmd.Parameters.Add(new SqlParameter("@StopeItem", Comon.cInt(objRecord.StopeItem)));
                    objCmd.Parameters.Add(new SqlParameter("@IsUnbreakable", Comon.cInt(objRecord.IsUnbreakable)));
                    ...
                    objCmd.Parameters.Add(new SqlParameter("@BAGET_W",  objRecord.BAGET_W));
